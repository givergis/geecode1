...
function getcampdetails(string1)
...
xRequest1.open("get","viewjsp.jsp?q="+string1,"true");
...
<form>
  ...
  <select class="form-control" id="sel1" name="sel1" onchange="getcampdetails(this.value)">
    <option>--</option>
