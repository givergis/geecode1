...
rs=s.executeQuery("SELECT * FROM `reportmissingperson` ");
...
<th>Age</th>
<th>Guardian Name</th>
<th>Missing From District</th>
<th>Missing Person Address</th>
...
<td><img src="<%=rs.getString(11)%>" height="100px" width="100px"/></td>
