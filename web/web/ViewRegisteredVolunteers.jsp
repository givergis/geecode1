...
function getvolunteersdetails(string1,string2)
...
xRequest1.open("get","viewjsp2.jsp?q="+string1+"&r="+string2,"true");
...
<form>
  ...
  <label for="sel2">Select Area:</label>
  <select class="form-control" id="sel1area" name="sel2" onchange="getvolunteersdetails(sel1.value,this.value)">
    <option>--</option>
